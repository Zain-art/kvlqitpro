    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Finished Goods
                            <div class="page-title-subheading">Move inventory  From Work-in-Process to Finish Goods.
                            </div>

                        </div>
                    </div>
                    <div class="page-title-actions">
                        <a href="{{ route('newFinishedGoods') }}">
                            <button type="button" data-toggle="tooltip" title="" data-placement="bottom" class="btn-shadow mr-3 btn btn-dark" data-original-title="Add Finish Goods Inventory">
            ...
            <div class="row card mx-0 mb-2 pt-1">
                <div class="col-md-12">
                    <form action="{{route('searchFinishedGoods')}}" method="post">
                        @csrf
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="form-group col-2 ml-2">
                                ...
                                <input type="text" name="invoice_number" class="form-control" value="{{(isset($invoice_number)) ? $invoice_number : ''}}" placeholder="Voucher No.">
                            </div>
                    ...
                    <div class="main-card mb-3 card">
                        ...
                        <div class="table-responsive">
                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                ...
                                <tbody>
                                    @if(!empty($lists)) @php $i=1; @endphp @foreach($lists as $list)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="mb-2 mr-2 btn-group">
                                                ...
                                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(68px, 33px, 0px);">
                                                    <a href="{{route('editFinishedGoods',$list->id)}}"><button type="button" tabindex="0" class="dropdown-item">Edit</button></a>
                                                    <a href="#" onclick="deleteRecord('{{route('deleteFinishedGoods',$list->id)}}');"><button type="button" tabindex="0" class="dropdown-item">Delete</button></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="row justify-content-end no-gutters pr-4 align-items-baseline mt-3">
                            ...
                            <div class="col-md-2 col-sm-4 col-6">
                                <span style="display: inline-block; width: 100px; font-weight:600; border: 1px solid rgb(199, 197, 197); border-radius: 4px;" class="py-1 px-2">{{(isset($total) ? $total : '')}}</span>
                            </div>
                        </div>
