    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                ...
                <div class="page-title-wrapper">
                    ...
                    <div class="page-title-actions">
                        <a href="{{route('newvendorpayment')}}">
                            <button type="button" data-toggle="tooltip" title="" data-placement="bottom" class="btn-shadow mr-3 btn btn-dark" data-original-title="Add New Payment">
            ...
            <div class="text-right">
                <a href="{{route('vendorPagePdf',['from_date'=>(isset($from_date)) ? $from_date : 'none','to_date'=>(isset($to_date)) ? $to_date : 'none','vendor_name'=>(isset($vendor_name)) ? $vendor_name : 'none','invoice_number'=>(isset($invoice_number)) ? $invoice_number : 'none' ])}}" target="_blank" class="btn btn-outline-success mb-2">Download PDF</a>
            </div>
                    ...
                    <form action="{{route('searchVendorPayment')}}" method="post">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="form-group col-2 ml-2">
                                ...
                                <input type="text" name="vendor_name" class="form-control" value="{{(isset($vendor_name)) ? $vendor_name : ''}}" placeholder="name">
                            </div>
                            <div class="form-group col-2 ml-2">
                        ...
                        <div class="table-responsive">
                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{$vendor_payment->received_date}}</td>
                                    <td class="text-center">
                                        <div class="mb-2 mr-2 btn-group">
                                            ...
                                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(68px, 33px, 0px);">
                                                <a href="{{route('editVendorPayment',$vendor_payment->id)}}"><button type="button" tabindex="0" class="dropdown-item">Edit</button></a>
                                                <a href="{{route('deleteVendorPayment',$vendor_payment->id)}}"><button type="button" tabindex="0" class="dropdown-item">Delete</button></a><a href="{{route('vendorRecordPdf',$vendor_payment->id)}}" ><button type="button" tabindex="0" class="dropdown-item">PDF</button></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
