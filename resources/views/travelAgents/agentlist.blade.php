            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    ...
                    <div class="page-title-actions">
                        <a href="{{route('newtravelagent')}}">
                            <button type="button" data-toggle="tooltip" title="" data-placement="bottom" class="btn-shadow mr-3 btn btn-dark" data-original-title="Add New Agent">
                    ...
                    <div class="main-card mb-3 card">
                        ...
                        <div class="table-responsive p-3">
                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                ...
                                <tr class="">
                                    <td class="text-start text-muted">{{$agent->id}}</td>
                                    <td>
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left flex2">
                                                    <div class="widget-heading">{{$agent->Name}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="">{{$agent->Phone}}</td>
                                    <td class="">{{$agent->Address}}</td>
                                    <td class="">{{$agent->Commission_persent}}</td>
                                    ...
                                    <td class="text-center">
                                            ...
                                            <div class="mb-2 mr-2 btn-group">
                                                ...
                                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(68px, 33px, 0px);">
                                                    ...
                                                    <a href="{{route('edittravelagent',$agent->id)}}"><button type="button" tabindex="0" class="dropdown-item">Edit</button></a>
                                                    <a  href="{{route('deletetravelagent',$agent->id)}}"><button type="button" tabindex="0" class="dropdown-item">Delete</button></a>
                                                </div>
                                            </div>
