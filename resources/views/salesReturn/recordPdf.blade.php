...
<div>
        <table style="width: 100%;" collspacing="0" class="" border="0">
            <tr>
                ...
                <td class="w-20">
                    <div class="mb-3">
                    <p class="mb-1"><b>Invoice #:</b> {{$saleReturn->invoice_number}}</p>
                        <p class="mb-1"><b>Invoice Date:</b> {{$saleReturn->invoice_date}}</p>
                    </div>
                </td>
            </tr>
    ...
    <p class="text-right" style="font-size: 1.4rem;"><b>Sale Invoice</b></p>
