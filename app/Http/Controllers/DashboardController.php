...
class DashboardController extends Controller
{
    ...
    public function rawMaterial($id){
        $ministock=DB::table('items')->where('category',Config::get('constants.RAW_MATERIAL_MINIMUM_STOCK'))->where('id',3)->sum('stock')->get();
           return view('dashboard',['ministock'=>$ministock]);
    }
    public function index()
    {
        ...
        return view('dashboard', array('data' => $data,'todo'=>$todo,'inprogress'=>$inProgress,'ready'=>$ready,'complete'=>$complete));
    }
    public function getMontlyAccountBalance($general_ledger_account_id,$journal_sum_rule,$fromdate,$todate,$voucher_number_prefix){
        ...
        $groupedBalance = DB::table('general_ledger_transactions')
            ...
            ->selectRaw('MONTH(voucher_date) as month,
