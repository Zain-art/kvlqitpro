...
<body>
    ...
    <div>
        <table style="width: 100%;" collspacing="0" class="" border="0">
            <tr>
                ...
                <td class="w-20">
                    <div class="mb-3">
                    <p class="mb-1"><b>Invoice #:</b> {{$generalReceipts->voucher_number}}</p>
                        <p class="mb-1"><b>Invoice Date:</b> {{$generalReceipts->voucher_date}}</p>
                    </div>
                </td>
            </tr>
    ...
    <p class="text-right mb-2" style="font-size: 1.4rem;"><b>General Receipt Invoice </b></p>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    {{(isset($generalReceipts)) ? ($item->id == $invoiceItem['general_ledger_account_id']) ? $item->name : '' : ''}}
                    @endforeach
                    @endif
            ...
            <tr>
                ...
                <td>{{$generalReceipts->net_total}}</td>
