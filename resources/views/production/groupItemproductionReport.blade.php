    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <div class="row card mx-0 mb-2 pt-1">
                <div class="col-md-12">
                    <form action="{{route('searchGroupItemproductionReport')}}" method="post">
                    @csrf
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-card mb-3 card">
                        <div class="card-header">Production Item Group Report
                        </div>
                                ...
                                @if(!empty($finaldata))
                                    ...
                                    @foreach($finaldata as $data)
                                        <tr>
                                            ...
                                            <td class="text-center text-muted">{{$data['item_qty']}}</td>
                                            <td class="text-center text-muted">{{$data['item_price']}}</td>
                                            <td class="text-center text-muted">{{$data['amount']}}</td>
                                        </tr>
                                        @php
                                            $i++;
                                        @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center text-muted font-weight-bold">{{$net_total}}</td>
                                    </tr>
                                @endif
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-card mb-3 card">
                        <div class="card-header">Post Production List
                                ...
                                @if(!empty($EmployeePostPorductionList))
                                    ...
                                    @foreach($EmployeePostPorductionList as $list)
                                        <tr>
                                            ...
                                            <td class="text-center   {{ ($list->debit >0 ) ? 'badge-danger' : '' }}">{{ ($list->credit >0 ) ? $list->credit : $list->debit }}</td></td>
                                            ...
                                            <td class="text-center">
                                                <div class="mb-2 mr-2 btn-group">
                                                    ...
                                                    <!--<a href="{{route('recordPDF',$list->id)}}" ><button type="button" tabindex="0" class="dropdown-item">PDF</button></a>-->
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
