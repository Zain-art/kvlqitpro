                        ...
                        <div class="table-responsive px-3">
                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">{{($list->priority == 1) ? 'To Do' : (($list->priority == 2) ? 'In Progress' : (($list->priority == 3) ? 'Ready' : 'Completed'))}}</td>
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="mb-2 mr-2 btn-group">
                                            ...
                                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(68px, 33px, 0px);">
                                                <a href="{{route('editToDo',$list->id)}}"><button type="button" tabindex="0" class="dropdown-item">Edit</button></a>
                                                <a href="#" onclick="deleteRecord('{{route('deleteTodo',$list->id)}}');"><button type="button" tabindex="0" class="dropdown-item">Delete</button></a>
