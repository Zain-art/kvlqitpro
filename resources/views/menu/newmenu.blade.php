        ...
        <div class="app-main__inner">
            ...
            <div class="main-card mb-3 card">
                <form class="Q-form" action="{{(isset($menus)) ? route('updatemenu') : route('savemenu')}}" method="post">
                    @csrf
                    <div class="card-body">
                        <h5 class="card-title">Menue Information</h5>
                        <div class="form-row">
                            <div class="col-md-6">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="position-relative form-group">
                                    <label for="name" class="">Route Path</label>
                                    <input type="text" name="route_path" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="position-relative form-group">
                                    <label for="name" class="">Menu Type</label>
                                    <div class="">
                                       <span class="d-inline-block mr-4"> <span class="">List </span><input type="radio" name="menu_type" id="" value="1"></span>
                                      <span> <span> Others </span> <input type="radio" name="menu_type" id="" value="0"></span>
                                    </div>
                                </div>
                            </div>
                            @if(isset($menus))
