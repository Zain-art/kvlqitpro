<x-app-layout>
    <div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <a href="{{route('itemsLedgerPagePdf',['from_date'=>(isset($from_date)) ? $from_date : 'none','to_date'=>(isset($to_date)) ? $to_date : 'none','invoice_number'=>(isset($invoice_number)) ? $invoice_number : 'none','item_ledger_id'=>(isset($item_ledger_id) ? $item_ledger_id : 'none') ])}}"  class="btn btn-outline-success mb-2 pdf">Download PDF</a>
            </div>


            <div class="row card mx-0 mb-2 pt-1">
                <div class="col-md-12">
                    <form action="{{route('searchItemsledger',['asad'=>'amir'])}}" method="post">
                        @csrf
                        ...
                        <div class="row no-gutters">
                            ...
                            <input type="hidden" name="item_ledger_id" value="{{isset($item_ledger_id) ? $item_ledger_id : ''}}">
