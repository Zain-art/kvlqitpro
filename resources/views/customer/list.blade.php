                    ...
                    <form action="{{route('searchCustomers')}}" method="post">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="form-group col-2 mx-2">
                                ...
                                <input type="text" name="customer_name" class="form-control" value="{{(isset($searchQuery)) ? $searchQuery :((isset($_GET['queries']['name'])) ? $_GET['queries']['name'] : '')}}">
                            </div>
                        ...
                        <div class="table-responsive p-3">
                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                ...
                                <tr class="">
                                    ...
                                    <td class="" style="max-width: 150px;">{{$customer->address}}</td>
                                    ...
                                    @if($customer->status == 1)
                                            <div class="mb-2 mr-2 btn-group">
                                                ...
                                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(68px, 33px, 0px);">
                                                    <a href="{{route('ledger',$customer->general_ledger_account_id)}}"><button type="button" tabindex="0" class="dropdown-item">Ledger</button></a>
                                                    <a href="{{route('editcustomer',$customer->id)}}"><button type="button" tabindex="0" class="dropdown-item">Edit</button></a>
                                                    <a onclick="deleteRecord('{{route('deletecustomer',$customer->id)}}');" href="#"><button type="button" tabindex="0" class="dropdown-item">Delete</button></a>
                                                </div>
                                            </div>
                                            @endif
