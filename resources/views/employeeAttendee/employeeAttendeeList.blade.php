    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                ...
                <div class="page-title-wrapper">
                    ...
                    <div class="page-title-actions">
                        <a href="{{ route('employeeAttendeeAdd') }}">
                            <button type="button" data-toggle="tooltip" title="" data-placement="bottom" class="btn-shadow mr-3 btn btn-dark" data-original-title="Add Salary">
            ...
            <div class="text-right">
                <a href="{{route('attendeePdf',['employee_name'=>(isset($employee_name)) ? $employee_name : 'none','invoice_number'=>(isset($invoice_number)) ? $invoice_number : 'none' ])}}" target="_blank" class="btn btn-outline-success mb-2">Download PDF</a>
                    ...
                    <form action="{{route('searchAttendeeRecords')}}" method="post">
                        ...
                        <div class="row no-gutters">
                            <div class="form-group col-2">
                                ...
                                <input type="text" name="employee_name" class="form-control" value="{{(isset($employee_name)) ? $employee_name : ((isset($_GET['queries']['name'])) ? $_GET['queries']['name'] : '')}}" placeholder="name">
                            </div>
                        ...
                        <div class="table-responsive" style="overflow-x: auto;">
                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-muted">{{$list->from_date}}</td>
                                    <td class="text-center text-muted">{{$list->to_date}}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="mb-2 mr-2 btn-group">
                                            ...
                                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(68px, 33px, 0px);">
                                                ...
                                                <a href="{{route('singleRecordPdf',$list->id)}}"><button type="button" tabindex="0" class="dropdown-item">PDF</button></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
