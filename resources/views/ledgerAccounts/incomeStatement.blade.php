                    ...
                    <div class="main-card mb-3 card">
                        ...
                        <div class="table-responsive">
                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                ...
                                <tr>
                                    <td class="text-left text-muted font-weight-bold" colspan="2">Opening Stock</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left text-muted font-weight-bold">{{$totalOpeningStock}}</td>
                                </tr>
                                <tr>
                                    <td class="text-left text-muted font-weight-bold" colspan="2">Purchases</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left text-muted font-weight-bold">{{$totalPurchasedStock}}</td>
                                </tr>
                                <tr>
                                    <td class="text-left text-muted font-weight-bold" colspan="2">Closing Stock</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left text-muted font-weight-bold">{{$totalClosingStock}}</td>
                                </tr>


                                <tr>
                                    <td class="text-left text-muted">Cost of Goods Sold Total</td>
                                    <td class="text-left text-muted font-weight-bold">{{$CostOfGoodsSold}}</td>
                                </tr>
                                <tr>
                                    <td class="text-left text-muted font-weight-bold" colspan="2">Expenses</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left text-muted font-weight-bold">{{$netProfileLoss}}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
