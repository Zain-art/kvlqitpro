    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    ...
                    <div class="page-title-actions">
                        <a href="{{ route('stockIssuesList') }}">
                            <button type="button" data-toggle="tooltip" title="" data-placement="bottom" class="btn-shadow mr-3 btn btn-dark" data-original-title="Stock Issue List">
            ...
            <div class="main-card mb-3 card">
                <form class="Q-form" action="{{(isset($stock_issue)) ? route('updateSaleReturn') : route('saveStockIssue')}}" method="post">
                    @csrf
                    <input type="hidden" name="id" id="id" value="{{(isset($stock_issue)) ? $stock_issue->id : ''}}">
                    <div class="card-body">
                        <h5 class="card-title">Stock Issue Information</h5>
                        <div class="form-row">
                            <div class="col-md-2">
                                <div class="position-relative form-group">
                                    <label for="exampleEmail11" class="">Voucher #</label>
                                    <input name="invoice_number" id="invoice_number" placeholder="" type="text" value="{{(isset($stock_issue)) ? $stock_issue->voucher_number : Config::get('constants.STOCK_ISSUE_VOUCHER_PREFIX').$invoice_number}}" class="form-control" readonly>
                                </div>
                            </div>
