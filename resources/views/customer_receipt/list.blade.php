    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                ...
                <div class="page-title-wrapper">
                    ...
                    <div class="page-title-actions">
                        <a href="{{route('newcustomer_receipt')}}">
                            <button type="button" data-toggle="tooltip" title="" data-placement="bottom" class="btn-shadow mr-3 btn btn-dark" data-original-title="Add New Receipt">
            ...
            <div class="text-right">
                <a href="{{route('customerRecPagePdf',['from_date'=>(isset($from_date)) ? $from_date : 'none','to_date'=>(isset($to_date)) ? $to_date : 'none','customer_name'=>(isset($customer_name)) ? $customer_name : 'none','invoice_number'=>(isset($invoice_number)) ? $invoice_number : 'none' ])}}" target="_blank" class="btn btn-outline-success mb-2">Download PDF</a>
            </div>
                    ...
                    <form action="{{route('searchCustomerReceipt')}}" method="post">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="form-group col-2 ml-2">
                                ...
                                <input type="text" name="customer_name" class="form-control" value="{{(isset($customer_name)) ? $customer_name : ''}}" placeholder="name">
                            </div>
                            <div class="form-group col-2 ml-2">
                        ...
                        <div class="table-responsive">
                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{$customer_receipt->received_date}}</td>
                                    <td class="text-center">
                                        <div class="mb-2 mr-2 btn-group">
                                            ...
                                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(68px, 33px, 0px);">
                                                <a href="{{route('editcustomer_receipt',$customer_receipt->id)}}"><button type="button" tabindex="0" class="dropdown-item">Edit</button></a>
                                                <a href="{{route('deletecustomer_receipt',$customer_receipt->id)}}"><button type="button" tabindex="0" class="dropdown-item">Delete</button></a><a href="{{route('customerRecieptRecordPdf',$customer_receipt->id)}}" ><button type="button" tabindex="0" class="dropdown-item">PDF</button></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
