...
class MenuController extends Controller
{
    ...
    public function menuList(){
        $menulist=DB::table('menus')->join('modules','menus.module','=','modules.id')->select('menus.*','modules.name')->orderByDesc('id')->paginate(20);
     ...
     public function newMenu(){
        ...
        return view('menu.newMenu',array('modules'=>$modules));
     }
     public function storeMenu(Request $request)
    {
        ...
        $validator = Validator::make($request->all(),[
            ...
            [
                ...
                'route_path.required' => 'The Module field is required.',
                'menu_type.required' => 'The Module field is required.',
            ]);
    ...
    public function updateMenu(Request $request){
         $userinfos=DB::table('menus')->join('modules','menus.module','=','modules.id')->where('id',$request->id)->firast()->get();
