...
<body>
    ...
    <h3 class="text-right"><b>salelist Item Wise Invoice List</b></h3>
    <div class="">
        ...
        <table class="table table-bordered" cellpadding="10px" cellspacing="10px">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{$salelist->vendor_name}}</td>
                    ...
                    <td class="">{{(isset($salelist)) ? $invoiceItem['item_qty'] : ''}} </td>
                    <td class="">{{(isset($salelist)) ? $invoiceItem['item_price'] : ''}} </td>
                    <td class="">{{(isset($salelist)) ? $invoiceItem['amount'] : ''}}</td>
                    <td class="">{{$salelist->invoice_date}}</td>
