                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-header">Menue List
                            <div class="btn-actions-pane-right">
                                ...
                                <a href="{{ route('activemenu') }}"><button class="active btn btn-focus mr-2">Active</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">@if($menu->status==1) Active @else Inactive @endif </td>
                                    ...
                                    <td class="text-center">
                                        <div class="mb-2 mr-2 btn-group">
                                            ...
                                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(68px, 33px, 0px);">
                                                <a href="{{route('editmenu',$menu->id)}}"><button type="button" tabindex="0" class="dropdown-item">Edit</button></a>
                                                <a href="{{route('deletmenu',$menu->id)}}"><button type="button" tabindex="0" class="dropdown-item">Delete</button></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
