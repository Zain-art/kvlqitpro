        ...
        <div class="app-main__inner">
                    ...
                    <div class="card mb-3 widget-content bg-midnight-bloom">
                        <div class="widget-content-wrapper text-white">
                            ...
                            <div class="widget-content-right">
                                <div class="widget-numbers text-white"><span>{{Config::get('constants.DEFAULT_CURRENCY').$data['netSales']}}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="mb-3 card">
                        <div class="card-header-tab card-header-tab-animation card-header">
                            ...
                            <ul class="nav">
                                <li class="nav-item"><a href="javascript:void(0);" class="active nav-link">Last 7 Months</a></li>
                            </ul>
                        </div>
                        <div class="card-body">
                                                            ...
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-right">
                                                                    <div class="font-size-xlg text-muted">
                                                                        <small class="opacity-5 pr-1">{{Config::get('constants.DEFAULT_CURRENCY')}}</small>
                    ...
                    <div class="card mb-3 widget-content">
                        <div class="widget-content-outer">
                            <div class="widget-content-wrapper">
                                ...
                                <div class="widget-content-right">
                                    <div class="widget-numbers text-success">{{Config::get('constants.DEFAULT_CURRENCY')}}{{$data['totalCash']}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card mb-3 widget-content">
                        <div class="widget-content-outer">
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left">
                                    <div class="widget-heading"><a href="{{ route('accountReceivable') }}">Account Receivable</a></div>
                                    <div class="widget-subheading">Revenue streams</div>
                                </div>
                                <div class="widget-content-right">
                                    <div class="widget-numbers text-warning">{{Config::get('constants.DEFAULT_CURRENCY')}}{{$data['accountReceivable']}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card mb-3 widget-content">
                        <div class="widget-content-outer">
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left">
                                    <div class="widget-heading"><a href="{{ route('accountPayable') }}">Account Payable</a></div>
                                    <div class="widget-subheading">People Interested</div>
                                </div>
                                <div class="widget-content-right">
                                    <div class="widget-numbers text-danger">{{Config::get('constants.DEFAULT_CURRENCY')}}{{$data['accountPayable']}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card mb-3 widget-content">
                        <div class="widget-content-outer">
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left">
                                    <div class="widget-heading"><a href="{{ route('rawMaterial') }}">Raw Material </a></div>
                                    <div class="widget-subheading">stock minimum</div>
                                </div>
                                <div class="widget-content-right">


                                    <div class="widget-numbers text-danger">{{Config::get('constants.RAW_MATERIAL_MINIMUM_STOCK')}}</div>
                            ...
                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="badge badge-warning">{{($user->status == 1) ? 'Active' : 'InActive'}}</div>
                                    </td>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="card-shadow-danger mb-1 widget-chart widget-chart2 text-left card border border-danger">
                        <div class="widget-content">
                            <div class="widget-content-outer">
                                <div class="widget-content-left fsize-1">
                                    <div class="text-muted opacity-6"><b>Title: </b> {{$list->title}}</div>
                                    <div class="text-muted opacity-6"><b>Desc: </b>{{$list->description}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="card-shadow-danger mb-1 widget-chart widget-chart2 text-left card border border-success">
                        <div class="widget-content">
                            <div class="widget-content-outer">
                                <div class="widget-content-left fsize-1">
                                    <div class="text-muted opacity-6"><b>Title: </b> {{$list->title}}</div>
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="card-shadow-danger mb-1 widget-chart widget-chart2 text-left card border border-warning">
                        <div class="widget-content">
                            <div class="widget-content-outer">
                                <div class="widget-content-left fsize-1">
                                    <div class="text-muted opacity-6"><b>Title: </b> {{$list->title}}</div>
